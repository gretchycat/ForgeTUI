...
theme_template={
        ...
        'scroll.h_tick': ('B50', '#000', '#aaa', 0, None),
        'scroll.v_tick': ('B50', '#000', '#aaa', 0, None),
        'scroll.handle': ('CIRCLE', '#aaa', '#000', 0, None),
        'scroll.handle_lock': ('CIRCLED X', '#aaa', '#000', 0, None),
        'slider.up': ( 'LRD', '#000', '#aaa', 0, None),
        'slider.down': ('ULR', '#000', '#aaa', 0, None),
        'slider.left': ('URD', '#000', '#aaa', 0, None),
        'slider.right': ('ULD', '#000', '#aaa', 0, None),
        'slider.h': ('LR', '#000', '#aaa', 0, None),
        'slider.h_tick': ('DIAMOND', '#000', '#aaa', 0, None),
        'slider.v_tick': ('DIAMOND', '#000', '#aaa', 0, None),
        'slider.handle': ('CIRCLE', '#aaa', '#000', 0, None),
        'slider.handle_lock': ('CIRCLED X', '#aaa', '#000', 0, None),
...
def make_theme(style=None, template=theme_template, fg="#aaa", bg="#000",
               inactive={'h':0,'s':0.0,'v':0.0}, parent=None,
               active={'h':0,'s':0.0,'v':0.33}):
    fcs_thm={}
